...
class LineChartsControllerTest < ActionController::TestCase
  ...
  test "should create line_chart" do
    assert_difference('LineChart.count') do
      post :create, line_chart: { month_name: @line_chart.month_name, total_income: @line_chart.total_income, year: @line_chart.year }
    end
  ...
  test "should update line_chart" do
    patch :update, id: @line_chart, line_chart: { month_name: @line_chart.month_name, total_income: @line_chart.total_income, year: @line_chart.year }
    assert_redirected_to line_chart_path(assigns(:line_chart))
  end
